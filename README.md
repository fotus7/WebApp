...
Application and website were also deployed on a local server computer, so only the employees have acces to the website, which sends HTTP requests to the server, started by the application.
